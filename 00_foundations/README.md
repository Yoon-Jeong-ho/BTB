...
- 딥러닝 코어 압축 루트: foundations를 끝낸 뒤 selected `02_deep_learning` unit([02_deep_learning](../02_deep_learning/README.md))을 먼저 보고, [03_nlp_bridge](../03_nlp_bridge/README.md) 로 가서 embedding과 attention을 잇는다.
