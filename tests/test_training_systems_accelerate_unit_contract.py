...
UNIT = ROOT / '06_training_systems/02_accelerate_workflows'
...
class TestAccelerateUnitContract(unittest.TestCase):
    maxDiff = None
    ...
    def test_labs_and_analysis_generate_outputs(self) -> None:
        ...
        self.assertIn('accelerate_replaced_calls', scratch)
