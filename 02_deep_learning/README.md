...
| [02_cnn_and_image_classification](02_cnn_and_image_classification/README.md) | runnable | local receptive field, convolution, pooling이 이미지 분류에 왜 맞는지 본다. |
...
| [05_autoencoders_and_representation_learning](05_autoencoders_and_representation_learning/README.md) | runnable | 복원 과제로 latent representation을 만드는 기본기를 정리한다. |
| [06_generative_models_vae_gan](06_generative_models_vae_gan/README.md) | runnable | 확률적 생성과 adversarial 학습이라는 두 generative family를 비교한다. |
