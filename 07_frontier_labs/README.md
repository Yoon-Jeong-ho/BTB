...
| Unit | Status | Focus |
| --- | --- | --- |
| [01_paper_reproduction_playground](01_paper_reproduction_playground/README.md) | planned | 논문 하나를 재현 가능한 실험 묶음으로 바꾸는 기본 playground를 만든다. |
| [02_capstone_model_building](02_capstone_model_building/README.md) | planned | 여러 이전 단위를 묶어 하나의 end-to-end 모델 프로젝트를 설계한다. |
| [03_agentic_training_and_eval_loops](03_agentic_training_and_eval_loops/README.md) | planned | agentic workflow가 training/eval/triage loop를 어떻게 바꾸는지 실험한다. |
